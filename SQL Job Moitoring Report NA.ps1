...
$FailureCategory = 'NA Monday Job Monitoring'
...
@recipients='lijith.lakshmanan@simplot.com ; lijith.lakshmanan@intimetec.com ; Sudhir.Kumar@intimetec.com; thanuja.b@intimetec.com; b.thanuja@simplot.com',    
@subject = 'SQL Job Moitoring Report NA',  
@body = @errorbody1,  
@body_format = 'HTML',  
@importance='High'  
